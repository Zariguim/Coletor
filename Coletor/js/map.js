...
const MapManager = {
    ...
    confirmPlacement() {
        ...
        // CORREÇÃO: A limpeza agora acontece aqui, garantindo que o estado (pino e UI)
        // seja resetado para TODAS as funcionalidades que usam o posicionamento manual.
        this.cancelPlacement();
    },
    ...
    isUserInsideSelectedTalhao() {
        ...
        turf.geomEach(talhaoGeoJSON, (geom) => {
            // CORREÇÃO: A variável `point` estava indefinida, foi trocada por `userPoint`
