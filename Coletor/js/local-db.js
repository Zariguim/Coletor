...
const DB_VERSION = 6; // ATUALIZADO: Versão incrementada para nova tabela de anotações pendentes
...
function openDB() {
    return new Promise((resolve, reject) => {
        ...
        request.onupgradeneeded = (event) => {
            ...
            // NOVO: Cria o object store para as anotações pendentes de sincronização.
