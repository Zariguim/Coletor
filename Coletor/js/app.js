...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function initializeApp() {
        ...
        UI.dom.alvoBtn.addEventListener('click', () => {
            ...
            UI.dom.fabContainer.classList.remove('open'); // Recolhe o FAB
        ...
        // Listener do botão de Demarcação
        ...
        // Listener do botão de Aferições (NOVO)
        ...
        MapManager.map.on('click', () => {
            // CORREÇÃO: Verifica se não está no modo de desenho ou demarcação A/B antes de desmarcar
