...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setSyncStatus(text, type = null, autoHide = true) {
    ...
    // ATUALIZADO: para sempre dar zoom no talhão clicado
    function showTalhaoInfo(talhao, clickedLayer) {
        ...
        // CORRIGIDO: Sempre aplica o zoom ao clicar em um talhão.
