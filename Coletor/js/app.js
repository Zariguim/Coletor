...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function showTalhaoInfo(talhao, clickedLayer) {
        ...
        dom.fabContainer.classList.remove('hidden'); // Mostra o botão de ações
    }
    ...
    function hideTalhaoInfo() {
        ...
        dom.fabContainer.classList.add('hidden'); // Esconde o botão de ações
        dom.fabContainer.classList.remove('open'); // Garante que o menu de ações feche
    }
    ...
    // NOVO: Evento para o botão de ações principal
