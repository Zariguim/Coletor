...
const AfericaoModal = {
    ...
    dom: {
        ...
        percaColheitaBtn: document.getElementById('perca-colheita-btn'),
        estimativaProdutividadeBtn: document.getElementById('estimativa-produtividade-btn'), // NOVO BOTÃO
    ...
    init() {
        ...
        this.dom.percaColheitaBtn.addEventListener('click', () => this.openPercaColheitaModal());
        this.dom.estimativaProdutividadeBtn.addEventListener('click', () => this.openEstimativaProdutividadeModal()); // NOVO EVENTO
    ...
    // ===================================================================================
    //  PERCA NA COLHEITA - CHAMADA
    // ===================================================================================

    openPercaColheitaModal() {
        this.closeChoiceModal(false);
        PercaColheitaModal.open(this.state.currentTalhao);
    },

    // ===================================================================================
    //  ESTIMATIVA DE PRODUTIVIDADE - CHAMADA (NOVO)
    // ===================================================================================

    openEstimativaProdutividadeModal() {
        this.closeChoiceModal(false);
        EstimativaProdutividadeModal.open(this.state.currentTalhao);
    },
};