...
const AfericaoModal = {
    ...
    dom: {
        ...
        percaColheitaBtn: document.getElementById('perca-colheita-btn'), // NOVO BOTÃO
    ...
    init() {
        ...
        this.dom.percaColheitaBtn.addEventListener('click', () => this.openPercaColheitaModal()); // NOVO EVENTO
    ...
    // ===================================================================================
    //  PERCA NA COLHEITA - CHAMADA (NOVO)
    // ===================================================================================
