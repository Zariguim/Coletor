...
const AlvoModal = {
    ...
    save() {
        ...
        const newRecord = {
            lat: lat,
            lng: lng,
            alvos: this.state.alvos.map(a => a.name) // Salva apenas os nomes dos alvos para este ponto
        };
        ...
        // 4. Exibe o botão de download (caso seja o primeiro registro)
    ...
    /**
     * Limpa a lista de alvos para um novo registro.
     */
    loadAlvos() {
        // Sempre começa com uma lista vazia para cada novo ponto
        this.state.alvos = [];
    },
