// ===================================================================================
//  MÓDULO DE GERENCIAMENTO DE DADOS (LOCAL E REMOTO) - VERSÃO CORRIGIDA
// ===================================================================================
...
const DataManager = {
    ...
    async deleteMonitoringRecord(recordId) {
        ...
        if (navigator.onLine) {
            try {
                // Passo 1: Pega o registro para achar a URL da imagem
                ...
                // Passo 2: Apaga o registro do banco de dados
                ...
                // Passo 3: Se o registro do BD foi apagado, apaga a imagem do Storage
                ...
                // Passo 4: Apaga o registro do cache local
            ...
            // Lógica offline: agenda a exclusão para quando estiver online
            await savePendingDeletion({ id: recordId });
            await deleteHistoryItem(recordId);
    ...
    async syncPendingDeletions() {
        ...
        for (const item of pendingDeletions) {
            try {
                // Repete a mesma lógica da exclusão online
