...
<coordinates>${coordinates}</coordinates>
    ...
    async saveDemarcation(talhao, points, description, area) {
        ...
        // Estrutura CSV com delimitador claro para evitar erros de parsing
    ...
    async finalizeAllMonitoring() {
        ...
        // CORREÇÃO: Dispara o evento para atualizar a interface de histórico
    ...
    async deleteMonitoringRecord(recordId) {
        ...
        // CORREÇÃO: Também remove a anotação pendente caso exista
