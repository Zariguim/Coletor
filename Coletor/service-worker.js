...
const CACHE_NAME = 'talhao-viewer-cache-v14'; // ATUALIZADO: Nova versão para incluir relatório e libs
...
const localUrlsToCache = [
  ...
  'js/relatorio-modal.js', // NOVO ARQUIVO
  'js/ui.js',
  'js/map.js',
  'js/data.js',
  'js/app.js',
...
const externalUrlsToCache = [
  ...
  'https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js', // PDF LIB
  'https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js' // PDF LIB
];
